...
export const AchievementsDataTab: React.FC<AchievementsDataTabProps> = ({ achievementsData }) => {
    return (
        <div className="flex flex-col gap-4">
            {achievementsData.map(achievement => (
               
                    <h2 className='font-coin'>{achievement.title}</h2>
...
export const SettingDataTab: React.FC<SettingDataTabProps> = ({ settingsData }) => {
    return (
