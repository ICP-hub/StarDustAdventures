    ...
    <div className='game-concept-sec'>
        <div className="gcs-sub-left">
            {gameConceptText.left.map((item, index) => (
                ...
                >
                    <h4 className="gcs-sl-title">{item?.title}</h4>
                    <p className="gcs-sl-text">{item?.text}</p>
                </div>
            ))}
        </div>
        
        <div className="gcs-sub-center">
            <div className="gcs-image-container">
        ...
        <div className="gcs-sub-right">
            {gameConceptText.right.map((item, index) => (
                <div
                    ...
                    data-aos-duration={1500}
                >
                    <h4 className="gcs-sr-title">{item?.title}</h4>
                    <p className="gcs-sr-text">{item?.text}</p>
                </div>
            ))}
        </div>
    </div>
